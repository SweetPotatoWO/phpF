<?php
namespace Common\Common\PhpAmqpLib\Channel;

use Common\Common\PhpAmqpLib\Connection\AbstractConnection;
use Common\Common\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use Common\Common\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use Common\Common\PhpAmqpLib\Exception\AMQPRuntimeException;
use Common\Common\PhpAmqpLib\Helper\DebugHelper;
use Common\Common\PhpAmqpLib\Helper\Protocol\MethodMap080;
use Common\Common\PhpAmqpLib\Helper\Protocol\MethodMap091;
use Common\Common\PhpAmqpLib\Helper\Protocol\Protocol080;
use Common\Common\PhpAmqpLib\Helper\Protocol\Protocol091;
use Common\Common\PhpAmqpLib\Helper\Protocol\Wait080;
use Common\Common\PhpAmqpLib\Helper\Protocol\Wait091;
use Common\Common\PhpAmqpLib\Message\AMQPMessage;
use Common\Common\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel
{
    ...
    /** @var \Common\Common\PhpAmqpLib\Helper\DebugHelper */
    protected $debug;

    /** @var \Common\Common\PhpAmqpLib\Connection\AbstractConnection */
    ...
    /** @var \Common\Common\PhpAmqpLib\Helper\Protocol\Protocol080|\Common\Common\PhpAmqpLib\Helper\Protocol\Protocol091 */
    protected $protocolWriter;

    /** @var \Common\Common\PhpAmqpLib\Helper\Protocol\Wait080|\Common\Common\PhpAmqpLib\Helper\Protocol\Wait091 */
    protected $waitHelper;

    /** @var \Common\Common\PhpAmqpLib\Helper\Protocol\MethodMap080|\Common\Common\PhpAmqpLib\Helper\Protocol\MethodMap091 */
    protected $methodMap;

    /** @var string */
    protected $channel_id;

    /** @var \Common\Common\PhpAmqpLib\Wire\AMQPReader */
     ...
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPRuntimeException
     */
    public function __construct(AbstractConnection $connection, $channel_id)
    {
        ...
        switch ($this->protocolVersion) {
            case self::PROTOCOL_091:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Common\Common\PhpAmqpLib\Wire\Constants091';
            ...
            case self::PROTOCOL_080:
                self::$PROTOCOL_CONSTANTS_CLASS = 'Common\Common\PhpAmqpLib\Wire\Constants080';
                $c = self::$PROTOCOL_CONSTANTS_CLASS;
                $this->debug = new DebugHelper($c);
                $this->amqp_protocol_header = $c::$AMQP_PROTOCOL_HEADER;
     ...
     * @param \Common\Common\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \Common\Common\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \Common\Common\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \Common\Common\PhpAmqpLib\Wire\AMQPWriter
     */
     ...
     * @return \Common\Common\PhpAmqpLib\Message\AMQPMessage
     */
     ...
     * @param int $timeout
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPOutOfBoundsException
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPRuntimeException
     * @return mixed
     */
