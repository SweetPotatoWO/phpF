...
class ChuanglanSmsApi {
    ...
    const API_BUS_ACCOUNT= 'N7573121'; // 创蓝营销短信API账号

    const API_BUS_PASSWORD= 'IzQcShBn9r3693';// 创蓝营销短信API密码
     ...
     * @return bool
     */
	public function sendVerify($mobile,$terminal,$type,$deviceNo) {
