...
use Common\Common\PhpAmqpLib\Channel\AMQPChannel;
use Common\Common\PhpAmqpLib\Channel\AbstractChannel;
use Common\Common\PhpAmqpLib\Exception\AMQPProtocolConnectionException;
use Common\Common\PhpAmqpLib\Exception\AMQPRuntimeException;
use Common\Common\PhpAmqpLib\Exception\AMQPTimeoutException;
use Common\Common\PhpAmqpLib\Wire\AMQPReader;
use Common\Common\PhpAmqpLib\Wire\AMQPTable;
use Common\Common\PhpAmqpLib\Wire\AMQPWriter;
use Common\Common\PhpAmqpLib\Wire\IO\AbstractIO;
use Common\Common\PhpAmqpLib\Wire\IO\SocketIO;
use Common\Common\PhpAmqpLib\Wire\IO\StreamIO;
...
class AbstractConnection extends AbstractChannel
{
    ...
    /** @var \Common\Common\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     * @return array
     * @throws \Exception
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPTimeoutException
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPRuntimeException
     */
     ...
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPProtocolConnectionException
     */
    ...
    /**
     * @return \Common\Common\PhpAmqpLib\Wire\IO\AbstractIO
     */
