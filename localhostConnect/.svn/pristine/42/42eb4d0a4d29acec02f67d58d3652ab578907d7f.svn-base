...
class PushPayload {
     ...
     * 设置推送的系统  安卓或则IOS系统
     * @param type $platform
     * @return \Common\Common\Jpush\PushPayload
     */
    ...
    public function build() {
        ...
        if (count($this->options) <= 0) {
            $this->options(array('apns_production' => true)); //线上版本为true
        }
    ...
    public function clearSmsMessage() {
