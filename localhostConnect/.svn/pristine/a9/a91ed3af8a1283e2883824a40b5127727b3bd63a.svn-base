...
defined('DOMAIN') or define('DOMAIN', 'test.51heho.com'); //主域名
defined('UPLOAD') or define('UPLOAD', 'http://res.'.DOMAIN); //图片服务器
defined('SITE') or define('SITE', 'http://www.'.DOMAIN.'/');  //站点地址
defined('WECHAT') or define('WECHAT', 'http://www.'.DOMAIN.'/Wechat/'); //微信地址
defined('COOKIE_DOMAIN') or define('COOKIE_DOMAIN', 'www.'.DOMAIN);
defined('JAVASERVICE') or define('JAVASERVICE', 'http://192.168.1.213:5100');  //APP根目录 ,用于HX返回地址和接口根目录
defined('XINLANGAPID') or define('XINLANGAPID', '31641035');  //新浪短连接APPID
...
defined('ActivityUrl') or define("ActivityUrl", "http://hd.test.51heho.com/Backend/GoCallback/olderUserEvent");   //活动访问的地址
