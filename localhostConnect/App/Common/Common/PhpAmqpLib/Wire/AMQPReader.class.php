<?php
namespace Common\Common\PhpAmqpLib\Wire;

use Common\Common\PhpAmqpLib\Exception\AMQPInvalidArgumentException;
...
use Common\Common\PhpAmqpLib\Exception\AMQPIOWaitException;
use Common\Common\PhpAmqpLib\Helper\MiscHelper;
...
class AMQPReader extends AbstractClient
{
     ...
     *
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPIOWaitException
