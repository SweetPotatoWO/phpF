<?php
namespace Common\Common\PhpAmqpLib\Wire\IO;

use Common\Common\PhpAmqpLib\Exception\AMQPIOException;
...
class StreamIO extends AbstractIO
{
    ...
    /**
     * @param int $len
     * @throws \Common\Common\PhpAmqpLib\Exception\AMQPIOException
     * @return mixed|string
     */
