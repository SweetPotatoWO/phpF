...
return array(
    ...
    'DB_USER' => 'root', // 用户名  
    'DB_HOST' => '192.168.1.221', // 服务器地址
    'DB_NAME' => 'connect', // 数据库名
    'DB_PORT' => '3306', // 端口
    'DB_PWD' => 'cmKR5jsp@S1UqPQ2', // 密码
    'DB_PREFIX' => 'd_', // 数据库表前缀 */
    ...
    'DB_PARAMS' => array(\PDO::ATTR_CASE => \PDO::CASE_NATURAL),
    // 允许访问列表和默认模块
    'MODULE_ALLOW_LIST' => array('Frontend', 'Wechat','Backend', 'Api',  'MobileApi','SmallApi'),
    ...
    'LOAD_EXT_CONFIG' => 'messageInfo,siteConfig,ueditorConfig',
    'URL_DENY_SUFFIX' => 'ico|png|gif|jpg', // URL禁止访问的后缀设置
    /* URL设置 */
    'URL_CASE_INSENSITIVE' => false, // 默认false 表示URL区分大小写 true则表示不区分大小写
    'URL_MODEL' => 3, // URL访问模式,可选参数0、1、2、3,代表四种模式
    /* 系统缓存 */
    'DATA_CACHE_TYPE' => 'Redis',
    'REDIS_AUTH' => 'mipr8VaKHWtcHaf2',
    ...
    'MAIL_FROMNAME' => '启脉', //发件人姓名
    'MAIL_PASSWORD' => 'Qhz1028', //邮箱密码
    'MAIL_CHARSET' => 'utf-8', //设置邮件编码
    'MAIL_ISHTML' => TRUE, // 是否HTML格式邮件
    //Neo4j配置
//    'Neo_host' => 'http://neo4j:123qwe@localhost:7474',
    'Neo_host' => 'http://neo4j:A2h1cRbkoiN87pxp@192.168.1.227:7474',
    /*'Rabbit_host' => [
        'host' => '172.18.3.177',
        'port' => 5672,
        'user' => 'qhzmq007',
