...
# crontab命令：
# 监控线上服务稳定性情况
# * */1 * * * sh /data001/data/websites/Connect/Shell/outtimeDeal.sh start >> /data001/data/websites/Connect/Publish/logs/outtimeDeal.log

# PHP命令
php="/usr/local/php7/bin/php  /data001/data/websites/Connect/Publish/cli.php"

# 在这里配置所有需要【守护】的PHP进程
proc_list='Task/upFriendApply/mask/mboxd5b7bb20ad654748c04892be29b67212'
